...
module.exports = {
    name: 'config-ticket',
    usage: 'config-ticket',
    description: `Permet de configurer l'embed du ticket`,
    category: "Ticket",
        ...
        if (db.get(`owner_${client.user.id}_${message.author.id}`) === true) {
            ...
            .addComponents(
                ...
                let menuoptions = [
                    ...
                    { value: "Supprimer les choix", description: "", emoji: "🚫" },
              ...
              const msf =   message.channel.send({embeds: [embedbase],
                    ...
                    client.on("interactionCreate",async (i) => {
                        ...
                        if(i.customId === "embed1"+message.id){
                            ...
                            message.channel.awaitMessages({
                                ...
                                await channel.send({embeds : [embedbase], components: [row]})
                                await message.channel.send("Embed envoyée")
                    ...
                    client.on("interactionCreate", async (i) => { 
                        ...
                        switch (i.values[0]) {
                            case message.id + "Modifier le titre":
                                ...
                                case message.id + "Supprimer votre choix":
                        
                                    i.reply({content : "Votre choix à bien était supprimé",ephemeral : true})
                                break
